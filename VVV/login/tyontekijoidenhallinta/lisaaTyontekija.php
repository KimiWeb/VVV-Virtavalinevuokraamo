...
// tietokantakäsittely
    ...
    try {
      ...
      $insertLause = "INSERT INTO Henkilökunta (TyöntekijäID, Etunimi, Sukunimi, Puhelin, Lähiosoite, Posti_nro, Postitoimipaikka, Sähköposti) VALUES (:Ttun, :Etunimi, :Sukunimi, :Puhnro, :Lahiosoite, :Postinro, :Postitoimipaikka, :Email)";
